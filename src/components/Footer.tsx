    ...
    <footer className="bg-surface-container-low border-t border-surface-container w-full py-12 px-8 mt-20">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center space-y-8">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <a className="text-on-surface-variant hover:text-primary transition-colors font-body text-base" href="#">Terms of Service</a>
          <a className="text-on-surface-variant hover:text-primary transition-colors font-body text-base" href="#">Privacy Policy</a>
          <a className="text-on-surface-variant hover:text-primary transition-colors font-body text-base" href="#">Wholesale Guide</a>
        </div>
        
        <div className="pt-8 border-t border-surface-container w-full">
          <p className="text-on-surface-variant/60 font-body text-sm">© 2024 ANGGA JAYA Grosir. The Heritage Curator.</p>
        </div>
      </div>
    </footer>
  );
